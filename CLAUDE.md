...
| Collector IDs | `docs/COLLECTORS.md`. All three are created and pinned — never re-create one |
...
| Tests | `node:test`, no dependencies. `npm test` — 1,149 tests, must stay green |
| MCP server | `mcp/`, stdio JSON-RPC, no SDK. Eight tools. See `mcp/README.md` |
