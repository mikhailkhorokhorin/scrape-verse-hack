...
| | |
|---|---|
| Tests | **1,153**, across 61 files in `test/{pipeline,web,mcp,tools}/` |
...
test/                       1,153 tests, node:test, no dependencies
...
1,153 tests, `node:test`, no dependencies and no test framework to install:
